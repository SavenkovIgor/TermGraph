...
{
    return TextUtils::isTermWithDefinition(def);
}

QString TextProcessor::getTerm(const QString& def) const
{
    return TextUtils::getTerm(def);
}

QString TextProcessor::getDefinition(const QString& def) const
{
    return TextUtils::getDefinition(def);
}

QString TextProcessor::insertNewLineNearMiddle(const QString& str) const
{
    return TextUtils::insertNewLineNearMiddle(str);
}
