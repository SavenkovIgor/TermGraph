...
CheckingTextCursor::CheckingTextCursor(QStringView                   strView,
                                       ...
                                       optional<Direction>           autoStartSearch)
...
CheckingTextCursor CheckingTextCursor::rightWordBorder(QStringView strView, int pos, optional<Direction> autoStartSearch)
{
    return {strView, pos, CharTools::isLetterOrNumber, CharTools::notLetterOrNumber, autoStartSearch};
}

CheckingTextCursor CheckingTextCursor::leftWordBorder(QStringView strView, int pos, optional<Direction> autoStartSearch)
{
