...
TEST_F (LinkTest, SelectLink) {
    ...
    struct Data { QString src; int startFrom; bool result; int leftPos; int rightPos; bool isEmpty; int size; };

    std::vector<Data> data;

    data.push_back({.src = ""                                            , .startFrom = 0, .result = false, .leftPos = -1, .rightPos = -1, .isEmpty = true , .size = 0 });
    data.push_back({.src = " "                                           , .startFrom = 0, .result = false, .leftPos = -1, .rightPos = -1, .isEmpty = true , .size = 0 });
    data.push_back({.src = "  "                                          , .startFrom = 1, .result = false, .leftPos = -1, .rightPos = -1, .isEmpty = true , .size = 0 });
    data.push_back({.src = "} {"                                         , .startFrom = 0, .result = false, .leftPos = -1, .rightPos = -1, .isEmpty = true , .size = 0 });
    data.push_back({.src = "} {"                                         , .startFrom = 1, .result = false, .leftPos = -1, .rightPos = -1, .isEmpty = true , .size = 0 });
    data.push_back({.src = "} {"                                         , .startFrom = 2, .result = false, .leftPos = -1, .rightPos = -1, .isEmpty = true , .size = 0 });
    data.push_back({.src = "} {"                                         , .startFrom = 3, .result = false, .leftPos = -1, .rightPos = -1, .isEmpty = true , .size = 0 });
    data.push_back({.src = "{} {}"                                       , .startFrom = 2, .result = false, .leftPos = -1, .rightPos = -1, .isEmpty = true , .size = 0 });
    data.push_back({.src = " {a}"                                        , .startFrom = 1, .result = false, .leftPos = -1, .rightPos = -1, .isEmpty = true , .size = 3 });
    data.push_back({.src = " { abc2 }"                                   , .startFrom = 2, .result = true , .leftPos =  1, .rightPos =  9, .isEmpty = false, .size = 8 });
    data.push_back({.src = " {a} {b}"                                    , .startFrom = 2, .result = true , .leftPos =  1, .rightPos =  4, .isEmpty = false, .size = 3 });
    data.push_back({.src = "{}ab"                                        , .startFrom = 1, .result = true , .leftPos =  0, .rightPos =  2, .isEmpty = false, .size = 2 });
    data.push_back({.src = " {ab|94810de3-51b8-469e-b316-00248ffa2a45}"  , .startFrom = 2, .result = true , .leftPos =  1, .rightPos = 42, .isEmpty = false, .size = 41});
    data.push_back({.src = " { ab |94810de3-51b8-469e-b316-00248ffa2a45}", .startFrom = 2, .result = true , .leftPos =  1, .rightPos = 44, .isEmpty = false, .size = 43});
...
TEST_F (LinkTest, IsCursorOnLink) {
    ...
    struct Data { QString src; Idxs indices; bool result; };
...
TEST_F (LinkTest, LinkAt) {
    ...
    struct Data { QString src; int index; int start; int end; };
...
TEST_F (LinkTest, AddLink) {
    ...
    struct Data { QString src; Idxs indices; QString result; };
...
TEST_F (LinkTest, ExtendRight) {
    ...
    struct Data { QString str; Idxs indices; QString result; };
