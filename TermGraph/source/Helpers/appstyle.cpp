...
QColor AppStyle::Colors::Nodes::leaf = QColor("#6d9a28");
QColor AppStyle::Colors::Nodes::root = QColor("#802915");
QColor AppStyle::Colors::Nodes::orphan = QColor("#124b6a");

QColor AppStyle::Colors::Nodes::leafSelected = QColor("#83c31b");
QColor AppStyle::Colors::Nodes::rootSelected = QColor("#dc4c1d");
QColor AppStyle::Colors::Nodes::orphanSelected = QColor("#0b77b1");
